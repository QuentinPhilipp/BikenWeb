...
async function requestItinerary(){
    ...
    if (radio1.checked == true) {
        // Oneway mode
        url = window.location.href+"plan/itinerary?start="+startInput.value+"&destination="+destinationInput.value+"&distance="+distanceInput.value+"&type=oneway&render=false";
